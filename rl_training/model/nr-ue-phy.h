...
class NrUePhy : public NrPhy
{
  ...
  public:
    ...
    void UpdateSinrEst(std::vector<SpectrumValue> sinr_est);
  ...
  private:
    ...
    double GetSidelinkRssi(SpectrumValue psd, SpectrumValue interf);
    int numRB(SpectrumValue psd);
    ...
    std::vector<SpectrumValue> m_sinrEst;
