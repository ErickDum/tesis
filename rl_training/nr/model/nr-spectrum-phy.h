...
class NrSpectrumPhy : public SpectrumPhy
{
  ...
  public:
    ...
    void AddSlSinrEstChunkProcessor(Ptr<NrSlChunkProcessor> p);
    /**
    ...
    void UpdateSlSinrEstPerceived(std::vector<SpectrumValue> sinr_est);
    /**
    ...
    std::vector<SpectrumValue> m_slSinrEstPerceived;
