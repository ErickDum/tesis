...
struct SlResourceInfo
{
     ...
     * \param slPower The power level measure for the resource
     * \param slSinr The SINR measure for the resource
     */
    ...
    uint8_t slSubchannelLength{
        std::numeric_limits<uint8_t>::max()}; //!< Number of continuous subchannels starting from
                                              //!< the index
    double slPower{0.0}; //!< The power level measure for the resource 
    double slSinr{0.0};  //!< The SINR measure for the resource
...
struct SensingData
{
     ...
     * \param sinr_est The estimated SINR value over the used resource blocks
     * \param slpowers The measured power over the used resource blocks
                ...
                uint8_t sbChStartReTx2)
    {
        ...
        this->prio = prio;
        this->slRsrp = slRsrp;
        this->sinr_est = sinr_est;
        this->slpowers = slpowers;
    ...
    double sinr_est{0.0}; //!< The estimated SINR value over the used resource blocks
    std::vector<double> slpowers; //!< The measured power over the used resource blocks
    uint8_t gapReTx1{
