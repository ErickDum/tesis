...
class NrSlUeMac : public NrUeMac
{
  ...
  public:
    ...
    {
        SfnSf m_sfn;                                 //!< Sfn
        uint8_t m_sensingMethod;                      //!< Sensing method
        uint8_t m_resourceAllocationMethod;            //!< Resource allocation method
        uint16_t m_t0;                               //!< T0
        ...
        double m_PowerThreshold;                     //!< Energy threshold
    ...
    /**
     * \brief Set the sensing method
     * \param sensingMethod The sensing method to be used
     */
    void SetsensingMethod(uint8_t sensingMethod);

    /**
     * \brief Get the sensing method
     * \return The sensing method to be used
     */
    uint8_t GetsensingMethod() const;

    /**
     * \brief Set the resource allocation method
     * \param sensingMethod The resource allocation method to be used
     */
    void SetResourceAllocationMethod(uint8_t allocatinMethod);

    /**
     * \brief Get the resource allocation method
     * \return The resource allocation method to be used
     */
    uint8_t GetResourceAllocationMethod() const;
    ...
    /**
     * \brief Sets a threshold in W used for sensing based UE autonomous resource selection
     * \param thresPower The power threshold in W
     */
    void SetSlThresPsschPower(double thresPower);

    /**
     * \brief Gets a threshold in W used for sensing based UE autonomous resource selection
     * \return The power threshold in W
     */
    double GetSlThresPsschPower() const;
  ...
  private:
    ...
    uint8_t m_sensingMethod{0}; //!< Sensing method
    uint8_t m_resourceAllocationMethod{0}; //!< Resource allocation method
    ...
    double m_thresPower{1.875e-17}; //!< A threshold in W used for sensing based UE autonomous resource
                              //!< selection
